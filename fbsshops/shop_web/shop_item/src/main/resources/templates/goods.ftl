        ...
        <div class="shop_hd_topNav_all">
            ...
            <div class="shop_hd_topNav_all_right">
                <ul class="topNav_quick_menu">
                    ...
                    <li>
                        <div class="topNav_menu">
                            <a href="http://localhost:16666/cart/showlist" class="topNavHover">购物车<b id="carenumber">0</b>种商品<i></i></a>
                            <div class="topNav_menu_bd" style="display:none;" id="cartid">
                            </div>
                        </div>
                    </li>
    ...
    <div class="shop_hd_header">
        ...
        <div class="shop_hd_header_search">
            ...
            <div class="search_form">
                <form method="get" action="http://localhost:16666/search/keyword">
                    <div class="search_formstyle">
                        <input type="text" class="search_form_text" name="keyword" value="搜索其实很简单！" />
...
<div class="shop_goods_bd clear">
    ...
    <script type="text/javascript">
        ...
        function addCart() {
            ...
            location.href = "http://localhost:16666/cart/insert?gid="+gid+"&number="+gnumber;
        }
